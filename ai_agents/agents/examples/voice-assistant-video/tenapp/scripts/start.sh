...
export LD_LIBRARY_PATH=$(pwd)/ten_packages/system/ten_runtime_go/lib:$(pwd)/ten_packages/system/agora_rtc_sdk/lib:$(pwd)/ten_packages/extension/agora_rtm/lib:$(pwd)/ten_packages/system/azure_speech_sdk/lib:${LD_LIBRARY_PATH}
